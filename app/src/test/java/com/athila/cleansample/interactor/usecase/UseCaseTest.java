...
public class UseCaseTest {
    ...
    public void testExecuteOperationWithEmptyObservable() {
        ...
        values.add(1);
        values.add(2);
        when(mUseCase.buildUseCaseObservable()).thenReturn(Observable.empty());
    ...
    public void testExecuteOperationWithSequenceOfEvents() {
        ...
        values.add(2);
        values.add(3);
        when(mUseCase.buildUseCaseObservable()).thenReturn(Observable.from(values));
    ...
    public void testExecuteOperationWithError() {
        ...
        when(mUseCase.buildUseCaseObservable()).thenReturn(Observable.error(mockException));
