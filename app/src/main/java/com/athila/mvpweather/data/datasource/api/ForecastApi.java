...
import com.athila.mvpweather.data.datasource.api.retrorfit.DefaultRetrofit;
...
public interface ForecastApi {
    ...
    class Factory {
        public static ForecastApi create() {
            return DefaultRetrofit.get().create(ForecastApi.class);
        }
    }
}
